...
jQuery(function(){	
	$('.hide-rows').each(function() {
		...
		if (rows > hide_after) {
			$(this).append("<tr class='utility-row row-toggle hide-rows more'><td colspan='10'><b><a class='hide-rows'><span class='glyphicon glyphicon-chevron-down'></span> More</a></b></td></tr>"); //Placeholder
		}		
	});
	...
	$('a.hide-rows').click(function(event, duration) {			
		...
		if (utilityrow.hasClass('more')) {
			var inner = "<span class='glyphicon glyphicon-chevron-up'></span> Less";
		} else {
			var inner = "<span class='glyphicon glyphicon-chevron-down'></span> More";
		}
...
jQuery(function(){
	$('.add-record').each(function() {		
		...
		utilityrow.children('td').first().append("<a href=" + $(this).data('add-url') + "><span class='glyphicon glyphicon-plus'></span></a>"); //Placeholder
	});
});
...
jQuery(function(){
	...
	if (linklist.length) {
		$('a.nav-anchor').each(function () {
			...
			linklist.append('<li><a href="#' + this.id + '"><span class="glyphicon glyphicon-chevron-left"></span>' + title + badge + '</a></li>');		
		});
...
(function($){
	$.fn.jTruncate = function(options) {
		...
		var defaults = {
			length: 300,
			minTrail: 20,
			moreText: '<small><span class="glyphicon glyphicon-chevron-right"></span></small>',
			lessText: '<small><span class="glyphicon glyphicon-chevron-left"></span></small>',
			ellipsisText: "... "
			//moreAni: "",
			//lessAni: ""
		};
